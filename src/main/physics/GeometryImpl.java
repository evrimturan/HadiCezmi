...
import main.physics.Geometry.DoublePair;
 ...
 *
 * Version: $Id: GeometryImpl.java,v 1.1 2003/10/30 01:49:01 chmoh Exp $
 *
 ***************************************************************************/
  ...
  implements GeometryInterface
{
  ...
  /**
   * @see main.physics.Geometry#quadraticSolution
   **/
  @Override
public DoublePair quadraticSolution(double a, double b, double c) {
  ...
  /**
   * @see main.physics.Geometry#minQuadraticSolution
   **/
  @Override
public double minQuadraticSolution(double a,
  ...
  /**
   * @see main.physics.Geometry#perpendicularPoint
   **/
  @Override
public Vect perpendicularPoint(LineSegment line,
  ...
  /**
   * @see main.physics.Geometry#perpendicularPointWholeLine
   **/
  @Override
public Vect perpendicularPointWholeLine(LineSegment line,
  ...
  /**
   * @see main.physics.Geometry#applyReflectionCoeff
   **/
  @Override
public Vect applyReflectionCoeff(Vect incidentVect,
  ...
  /**
   * @see main.physics.Geometry#timeUntilWallCollision
   **/
  @Override
public double timeUntilWallCollision(LineSegment line,
  ...
  /**
   * @see main.physics.Geometry#reflectWall
   **/
  @Override
...
public Vect reflectWall(LineSegment line,
  ...
  /**
   * @see main.physics.Geometry#distanceSquared
   **/
   @Override
...
public double distanceSquared(double x1, double y1,
  ...
  /**
   * @see main.physics.Geometry#timeUntilCircleCollision
   **/
  @Override
public double timeUntilCircleCollision(Circle circle,
  ...
  /**
   * @see main.physics.Geometry#reflectCircle
   **/
  @Override
...
public Vect reflectCircle(Vect circle,
  ...
  /**
   * @see main.physics.Geometry#rotateAround
   **/
  @Override
...
public DoublePair timeUntilCircleCollision(Circle circle,
   ...
   *
   * @see main.physics.SimpleGeometry
   *
  ...
  /**
   * @see main.physics.Geometry#timeUntilRotatingWallCollision
   **/
  @Override
public double timeUntilRotatingWallCollision(LineSegment line,
  ...
  /**
   * @see main.physics.Geometry#reflectRotatingWall
   **/
  @Override
...
public Vect reflectRotatingWall(LineSegment line,
  ...
  /**
   * @see main.physics.Geometry#timeUntilRotatingCircleCollision
   **/
  @Override
public double timeUntilRotatingCircleCollision(Circle circle,
  ...
  /**
   * @see main.physics.Geometry#reflectRotatingCircle
   **/
  @Override
...
public Vect reflectRotatingCircle(Circle circle,
  ...
  /**
   * @see main.physics.Geometry#timeUntilBallBallCollision
   **/
  @Override
public double timeUntilBallBallCollision(Circle ball1,
  ...
  /**
   * @see main.physics.Geometry#reflectBalls
   **/
  @Override
