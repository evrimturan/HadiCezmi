...
public class BallMovementStrategy implements IMovementStrategy {
	...
	public void moveAnimation(Paintable context) {
		...
		((Ball) context).setxVel(((Ball) context).getxVel() * GameWindow.getL() / 500);
		...
		((Ball) context).setyVel(((Ball) context).getyVel() + Board.GRAVITY / 500);
		((Ball) context).setyVel(((Ball) context).getyVel() * GameWindow.getL() / 500);
